...
function checkSpam(source, example) {
  let loweredSource = source.toLowerCase();
  let loweredExample = example.toLowerCase();

  if(typeof source && typeof example !== 'string') {
    throw new Error('Parameter should be a String');
  }
  return !!(~loweredSource.indexOf(loweredExample));
}
